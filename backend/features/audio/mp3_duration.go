...
// Adapted from: https://github.com/kgiannakakis/mp3duration/tree/master/src/mp3duration
...
func mp3_calculateDuration(filename string) (duration float64, err error) {
	var f *os.File
