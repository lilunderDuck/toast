...
### Prerequisites
Make sure you have [Go](https://go.dev/dl/), [GCC](https://gcc.gnu.org/) to use `make` command, and [Bun](https://bun.com/) (or `npm` if you like, but requires modification) installed in your machine.
...
- `bun`: go to their download page: https://bun.com/
